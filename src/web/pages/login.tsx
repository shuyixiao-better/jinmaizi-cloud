...
import { LockKeyhole, ShieldCheck, UserRound, Wheat } from "lucide-react";
...
export function LoginPage() {
  ...
  return <div className="grid min-h-screen lg:grid-cols-[1.08fr_.92fr]">
    <section className="relative hidden overflow-hidden bg-[#171611] p-14 text-white lg:flex lg:flex-col">
      ...
      <div className="relative flex items-center gap-3"><div className="grid size-10 place-items-center rounded-xl bg-wheat-400 text-black"><Wheat /></div><span className="text-xl font-bold">金麦子云系统</span></div>
      ...
      <p className="relative text-xs text-white/25">Powered by Cloudflare Workers & D1</p>
    </section>
    <section className="flex items-center justify-center bg-[#f8f7f3] p-6">
      <div className="w-full max-w-105"><div className="mb-9 lg:hidden"><div className="mb-7 flex items-center gap-2.5 font-bold"><Wheat className="text-wheat-600" />金麦子云系统</div></div><p className="text-sm font-semibold text-wheat-700">欢迎回来</p><h2 className="mt-2 text-3xl font-bold tracking-tight">登录管理后台</h2><p className="mt-3 text-sm text-black/40">请输入管理员为你分配的账号和密码</p>
